...
/**
 * Handles `web+reaglex://` protocol launches declared in site.webmanifest.
...
export default function DeepLinkHandler() {
  ...
  useEffect(() => {
    ...
    try {
      // The target may be a custom URL like `web+reaglex://product/abc123`
      ...
      const path = decoded.replace(/^web\+reaglex:\/\//i, '/');
